...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientConfiguration.content_type'
        db.add_column('weave_clientconfiguration', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'ClientConfiguration.object_id'
        db.add_column('weave_clientconfiguration', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientConfiguration.content_type'
        db.delete_column('weave_clientconfiguration', 'content_type_id')

        # Deleting field 'ClientConfiguration.object_id'
        db.delete_column('weave_clientconfiguration', 'object_id')
