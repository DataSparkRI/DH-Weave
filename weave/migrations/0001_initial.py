...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('weave', ['WeaveManifest'])
        ...
        db.send_create_signal('weave', ['WeaveMetaPublic'])
        ...
        db.send_create_signal('weave', ['WeaveMetaPrivate'])
        ...
        db.send_create_signal('weave', ['WeaveHierarchy'])
