...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientConfiguration.image'
        db.add_column('weave_clientconfiguration', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientConfiguration.image'
        db.delete_column('weave_clientconfiguration', 'image')
