...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeaveFlatPublicMeta'
        db.create_table('weave_weaveflatpublicmeta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('h_e_index', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weave.HubEntityIndex'], null=True)),
            ('weaveEntityId', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
            ('min', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('max', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dataType', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('keyType', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('object_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('year', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dataTable', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('weave', ['WeaveFlatPublicMeta'])


    def backwards(self, orm):
        # Deleting model 'WeaveFlatPublicMeta'
        db.delete_table('weave_weaveflatpublicmeta')
