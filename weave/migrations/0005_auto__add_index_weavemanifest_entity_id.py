...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WeaveManifest', fields ['entity_id']
        db.create_index('weave_manifest', ['entity_id'])


    def backwards(self, orm):
        # Removing index on 'WeaveManifest', fields ['entity_id']
        db.delete_index('weave_manifest', ['entity_id'])
