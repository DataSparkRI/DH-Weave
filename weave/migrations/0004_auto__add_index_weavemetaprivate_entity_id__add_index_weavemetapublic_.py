...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WeaveMetaPrivate', fields ['entity_id']
        db.create_index('weave_meta_private', ['entity_id'])

        # Adding index on 'WeaveMetaPublic', fields ['entity_id']
        db.create_index('weave_meta_public', ['entity_id'])


    def backwards(self, orm):
        # Removing index on 'WeaveMetaPublic', fields ['entity_id']
        db.delete_index('weave_meta_public', ['entity_id'])

        # Removing index on 'WeaveMetaPrivate', fields ['entity_id']
        db.delete_index('weave_meta_private', ['entity_id'])
