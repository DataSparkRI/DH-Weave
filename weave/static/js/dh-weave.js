...
extend(DHWEAVE, {
	...
	setWeaveObj:function(weaveObj){
		...
		//self.Settings.WObj.path('WeaveDataSource', 'idFields').state(['title', 'name','object_id', 'keyType', 'year']);
                self.Settings.WObj.path('WeaveDataSource','idFields').state(['dataTable','object_id','year','keyType','dataType','name']);
	...
	addCallback:function(callback){
		...
		if ( weave.path("CompoundBarChartTool", "children", "visualization", "plotManager", "plotters", "plot", "heightColumns", "DynamicColumn").getState() == null){
