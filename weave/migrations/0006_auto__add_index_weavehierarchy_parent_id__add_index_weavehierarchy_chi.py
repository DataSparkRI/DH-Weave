...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WeaveHierarchy', fields ['parent_id']
        db.create_index('weave_hierarchy', ['parent_id'])

        # Adding index on 'WeaveHierarchy', fields ['child_id']
        db.create_index('weave_hierarchy', ['child_id'])


    def backwards(self, orm):
        # Removing index on 'WeaveHierarchy', fields ['child_id']
        db.delete_index('weave_hierarchy', ['child_id'])

        # Removing index on 'WeaveHierarchy', fields ['parent_id']
        db.delete_index('weave_hierarchy', ['parent_id'])
